 ...
 */
	...
	$image_id = get_term_meta( $term->term_id, 'logo_image_id', true );
?>	
	...
	<tr class="form-field">
		...
		<td>
			...
			<?php } else { ?>
				...
				<a href="#" class="ka4wp-remove-file" style="display:none"><?php esc_html_e('Remove image','kultur-api-for-wp') ?></a>
